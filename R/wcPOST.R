...
#'   
#'   This option is a preferred option for storing keys, passwords and other sensitive values. Your 
#'   \code{.Rprofile} should be secured via OS security/permissions (e.g. on Linux/OS X
#'   \code{.Rprofile} is stored within the home directory which is only accessible by an authorized
#'   user. However, you should not share your \code{.Rprofile} or include your \code{.Rprofile} in
#'   version control (e.g. git) if you use this option. An alternative is to read values from a
#'   different file in the home directory or to use environment variables.
#'   
#'   preformatted{ 
#'   options(wcAccessKey = 'E4iZhsfdje7590JDNR/VARTEZyhfwb84485X5Xw86ow=') 
...
#'   
#' @return an \code{httr} response object is returned. Content of the response can be obtained with the \code{httr::content()} function. 
